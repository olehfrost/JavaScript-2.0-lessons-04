...
function f4() {
    let myCheck = document.querySelector('.i-4');
...
function f5() {
    let myCheck = document.querySelector('.i-5');
    let out = document.querySelector('.out-5');
    if (myCheck.checked) {
        out.textContent = myCheck.value;
    } else {
        out.textContent = 'false';
    }
}
...
function f6() {
    let data = document.querySelector('.i-6');
...
function f10() {
    let col = document.querySelector('.i-10');
    let out = document.querySelector('.out-10');
    out.style.backgroundColor = col.value;
}
...
function f11() {
    let inp1 = document.querySelector('.i-111');
    let inp2 = document.querySelector('.i-112');
    inp2.value = inp1.value;
    inp2.style.backgroundColor = inp1;
}
...
function f13() {
    let pol = document.querySelector('.i-13');
...
function f14() {
    let area = document.querySelector('.t-14');
    let out = document.querySelector('.out-14');
    out.textContent = area.value;
}
...
function f15() {
    ...
    let area = document.querySelector('.t-15');
    let out = document.querySelector('.out-15');
    area.textContent = a.value;
    out.textContent = a.value;
}
...
function f18() {
    ...
    out.value = sel.value;
    document.querySelector('.i-18').innerHTML = sel;
}
...
function f19() {
    ...
    let inp = document.querySelector('.i-19');
...
function f20() {
    let select1 = document.querySelector('.s-201');
    let select2 = document.querySelector('.s-202');
